...
- Younger than24 yo: teens-early 20s
- 25-40 yo: young adults
- 41-65 yo: adults
- Older than 65 yo: seniors
...
ps <- ggplot(df_single, aes(predicted_categories, percent)) +
  geom_histogram(stat = "identity", fill="pink", color="black") +
  labs(x="predicted categories", y="frequency (%)", title="Single People") +
  scale_y_continuous(limits=c(0,100), breaks = seq(0,100,5)) +
...
pm <- ggplot(df_married, aes(predicted_categories, percent)) +
  ...
  labs(x="predicted categories", y="frequency (%)", title="Marrried People") +
  scale_y_continuous(limits=c(0,100), breaks = seq(0,100,5)) +
...
pd <- ggplot(df_divorc, aes(predicted_categories, percent)) +
  ...
  labs(x="predicted categories", y="frequency (%)", title="Divorced People") +
  scale_y_continuous(limits=c(0,100), breaks = seq(0,100,5)) +
...
psep <- ggplot(df_sep, aes(predicted_categories, percent)) +
  ...
  labs(x="predicted categories", y="frequency(%)", title="Separated People") +
  scale_y_continuous(limits=c(0,100), breaks = seq(0,100,5)) +
...
pw <- ggplot(df_widow, aes(predicted_categories, percent)) +
  ...
  labs(x="predicted categories", y="frequency", title="Widowed People") +
  scale_y_continuous(limits=c(0,100), breaks = seq(0,100,5)) +
